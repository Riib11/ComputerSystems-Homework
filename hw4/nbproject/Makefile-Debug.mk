...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/hw4: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/hw4 ${OBJECTFILES} ${LDLIBSOPTIONS} -l pistache

${OBJECTDIR}/helloworld.o: helloworld.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ipistache -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/helloworld.o helloworld.cpp
...
${OBJECTDIR}/testserver.o: testserver.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ipistache -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/testserver.o testserver.cpp
