...
sizes = [ 2**i for i in range(8,25) ] # len = 18

iters_min = 20
iters_max = 10000
iterations = list(reversed([int(
    ((iters_max - iters_min) / (2**len(sizes))) * (2**i) + iters_min)
...
for i in range(len(sizes)):
    ...
    print(f"2^{i+8}",":",str(1000000 * t / (size * iters)) + "us")
